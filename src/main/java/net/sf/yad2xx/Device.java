...
public class Device {
    ...
    public void setBitMode(byte pinDirection, FTDIBitMode bitMode) throws FTDIException {
        FTDIInterface.setBitMode(ftHandle, pinDirection, bitMode.getMode());
    }
     ...
     * @throws FTDIException D2XX API call failed, see exception fields for
     *                       details
     * @see FTDIInterface#setDataCharacteristics(long, byte, byte, byte)
     * @since 0.3
     */
     ...
     * @throws FTDIException D2XX API call failed, see exception fields for
     *                       details
     * @see FTDIInterface#setResetPipeRetryCount(long, long)
     * @since 1.0
     */
