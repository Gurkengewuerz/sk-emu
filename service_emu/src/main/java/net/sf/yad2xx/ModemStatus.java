...
public class ModemStatus {
    ...
    private final byte modemStatus;
    private final byte lineStatus;
    ...
    public String toString() {
        String result = "ModemStatus(modem: " + Integer.toHexString(modemStatus) +
                ", line: " +
                Integer.toHexString(lineStatus) +
                ")";
        return result;
    }
